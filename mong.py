...
class GUI:
    ...
    def CreateDB(self, event=None):
        try:
            ...
            lbl = tk.Label(self.root, text="Connected to database...")
            lbl.place(x=170,y=90)
            self.root.after(2000, lbl.destroy)
            lbl1 = tk.Label(self.root, text="Database created...")
    ...
    def AnaliseData(self, event=None):
        lbl_diagtype = tk.Label(master=self.root, text="Diagram type")
        ...
        lbl_xcoord = tk.Label(master=self.root, text="X Coordinate")
        ...
        lbl_ycoord = tk.Label(master=self.root, text="Y Coordinate")
